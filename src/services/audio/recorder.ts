 ...
 * 
 * NOTE: On Android, expo-av and @react-native-voice/voice compete for microphone access.
 * The app prioritizes live transcription, so audio recording is disabled on Android.
